...
public class Cutter : MonoBehaviour
{
    ...
    public static void UpdateFoodScript (Food newFood, Food originalFood) {
        newFood.frossenColor = originalFood.frossenColor;
        newFood.godtStegtColor = originalFood.godtStegtColor;
        newFood.overstegtColor = originalFood.overstegtColor;
        newFood.originColor = originalFood.originColor;
        newFood.lStegt = originalFood.lStegt;
        newFood.lFrossen = originalFood.lFrossen;
        newFood.temperature = originalFood.temperature;
        newFood.hasBeenSetup = originalFood.hasBeenSetup;
        newFood.density = originalFood.density;
    }
}
